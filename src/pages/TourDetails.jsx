    ...
    <section>
      <Container>
        <Row>
            ...
            <div className="tour__content">
              ...
              <div className="tour__info">
                ...
                <div className="tour__extra-details">
                  ...
                  {/* Burada orijinal "price" yerine "actualPrice" */}
                  <span>
          ...
          <Col lg="4">
            {/* Booking'e "price: actualPrice" ile geçiyoruz */}
...
const TourDetails = () => {
  ...
  // hotels içinden ilgili kaydı bul
  const tour = hotels.find((item) => item._id === id)

  // Değişkenleri tur içerisinden çekelim
  const {
    photo,
    title,
    desc,
  ...
  // Yorumların ortalama puanını hesapla
  const { totalRating, avgRating } = calculateAvgRating(reviews || [])

  const options = { day: 'numeric', month: 'long', year: 'numeric' }

  // Form submit (yorum ekleme)
  const submitHandler = (e) => {
    e.preventDefault()
    const reviewText = reviewMsgRef.current.value
